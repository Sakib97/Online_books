   ...
   <nav class="navbar navbar-expand-lg sticky-top navbar-dark py-4">
     ...
     <div class="collapse navbar-collapse" id="navbarSupportedContent">
       ...
       <li class="nav-item dropdown nav-tabs">
         ...
         <li class="nav-item nav-tabs">
           <a class="nav-link" href="search.php?status=0">Search</a>
         </li>
         <li class="nav-item nav-tabs">
...
<!--   <div class="s1" style="background-color: rgba(5, 59, 64, 0.93);
     border-radius: 0px;
     position: fixed;">

       <form class="example" action="search.php?status= <?php //echo $status; ?>" method="post" >
